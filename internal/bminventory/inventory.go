...
func (b *bareMetalInventory) validateHostsReadinessForInstall(cluster *common.Cluster) error {
	for _, chost := range cluster.Hosts {
		// TODO: Maybe run RefreshStatus before
...
func (b *bareMetalInventory) InstallCluster(ctx context.Context, params installer.InstallClusterParams) middleware.Responder {
	...
	if err = b.validateHostsReadinessForInstall(&cluster); err != nil {
